...
o.seed_elements(lon=4.5, lat=59.6, radius=100, number=5000,
                time=reader_arome.start_time, object_type=object_type)

#%%
# Running model
o.run(duration=timedelta(hours=24), time_step=300, time_step_output=300,outfile='my_leeway_output.nc')
